...
{
    public abstract class MyProject6WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MyProject6WebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MyProject6WebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MyProject6DbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MyProject6DbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MyProject6DbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MyProject6DbContext, Task<T>> func)
        {
            T result;
