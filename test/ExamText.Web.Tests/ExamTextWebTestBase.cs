...
{
    public abstract class ExamTextWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ExamTextWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ExamTextWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ExamTextDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ExamTextDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ExamTextDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ExamTextDbContext, Task<T>> func)
        {
            T result;
