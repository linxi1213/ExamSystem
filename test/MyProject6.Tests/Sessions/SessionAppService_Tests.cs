...
using Shouldly;
using Xunit;
using MyProject6.Sessions;

namespace MyProject6.Tests.Sessions
{
    public class SessionAppService_Tests : MyProject6TestBase
    {
        ...
        {
            var output = _sessionAppService.SayHello();
