...
namespace ExamText.Migrations
{
    ...
    [Migration("20201216073358_CreateExams")]
    partial class CreateExams
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExamText.ExamCompletions.ExamCompletion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ExamCompletionID")
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("ExamText.ExamQuestions.ExamQuestion", b =>
                {
                    ...
                    b.Property<string>("OrtherAnswerThree")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("OrtherAnswerTwo")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("ExamText.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("ExamText.Authorization.Users.User", null)
                        .WithMany("Claims")
